        ...
        const mappedDrivers: Partial<DriverPerformance>[] = allData.map((row: any) => {
          ...
          return {
            ...
            tollCost: Number(row.tolls_amount || 0) !== 0 ? -Math.abs(Number(row.tolls_amount || 0)) : 0,
             ...
             fuel_retail_price: Number(row.fuel_retail_price || 0),
             spotter_retail_price: Number(row.spotter_retail_price || 0),
             fuel_discount_price: Number(row.fuel_discount_price || 0),

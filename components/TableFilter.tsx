...
const DropdownSingleSelect = ({ options, selected, onChange, placeholder }: any) => {
  return (
    <select
      ...
      className="bg-zinc-950 border border-zinc-800 rounded px-2 text-zinc-300 font-sans text-[10px] w-full focus:outline-none focus:border-emerald-500 h-[26px]"
    >
        ...
        <div className="absolute top-full left-0 mt-1 bg-zinc-950 border border-zinc-700 rounded-lg shadow-2xl z-[9999] p-3 flex flex-col gap-3 min-w-[550px] w-full">
          ...
          <div className="flex flex-col gap-2 w-full">
            {filters.map(filter => {
              ...
              return (
                <div key={filter.id} className="grid grid-cols-[1fr_1fr_1fr_auto] gap-2 items-center bg-zinc-900/50 p-1.5 rounded border border-zinc-800 w-full">
                  <select
                    value={filter.field}
